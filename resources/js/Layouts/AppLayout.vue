          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <JetNavLink
                  :href="route('dashboard.root')"
                  :active="route().current('dashboard.root')"
                >
                  Dashboard
                </JetNavLink>
                <JetNavLink
                  :href="route('dashboard.compute')"
                  :active="route().current('dashboard.compute')"
                >
                  Ground Control
                </JetNavLink>
                <JetNavLink
                  :href="route('dashboard.mission')"
                  :active="route().current('dashboard.mission')"
                >
                  Mission Control
                </JetNavLink>
                <JetNavLink
                  :href="route('dashboard.monitor')"
                  :active="route().current('dashboard.monitor')"
                >
                  Monitoring
                </JetNavLink>
              </div>
                    ...
                    <JetResponsiveNavLink as="button">
                      <div class="flex items-center">
                        <svg
                          v-if="
                            Number(team.id) ===
                            Number($page.props.auth?.user.current_team_id)
                          "
                          class="mr-2 h-5 w-5 text-green-400"
                          fill="none"
                          stroke-linecap="round"
